...
const About = () => {
  return (
    <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <div className='flex w-full flex-col lg:flex-row items-cemter gap-20 my-20'>
        ...
        <div className='flex-1'>
            <p className='mb-10 max-w-2xl font-Ovo'>
                ...
                Throughout my career, I have had the privilege of collaborating with prestigious origanizations, constribution to their success and growth.
            </p>
