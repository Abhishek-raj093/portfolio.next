...
const Navbar = () => {
  ...
  return (
    <>
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-[-80%]'>
      ...
      flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : ""}`} >
        ...
        rounded-full px-1z py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50"}`}>
        ...
        <div className='flex items-center gap-4'>
            ...
            py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo'>Contect 
