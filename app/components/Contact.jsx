  ...
  return (
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/ footer-bg-color.png")] bg-no-repeat bg-center bg-[lenght:90%_auto]'>
       ...
       <form className='max-w-2xl mx-auto'>
        ...
        <textarea rows='6' placeholder='Enter your message' required className='flex-1 p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6'></textarea>
